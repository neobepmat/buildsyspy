...
SET BATCH_ROOT_MOUNTPOINT=Y:\GIT
SET BATCH_ROOT_MOUNTPOINT_COMMON=Y:\GIT
SET INTERNAL_STANDALONE=1

rem -------------------------------------------

rem se standalone, mappa su Y il shared folder di virtual box
IF [%INTERNAL_STANDALONE%] == [1] NET USE Y: \\VBOXSRV\C_DRIVE
...
IF [%INTERNAL_STANDALONE%] == [1] NET USE Y: /DELETE
