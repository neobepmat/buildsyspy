...
SET LOG_FILE=%ROOT_FOLDER%\src\log\SETUP_11-10_standalone.LOG
SET LOG_FILE_ERR=%ROOT_FOLDER%\src\log\SETUP_ERR_11-10_standalone.LOG
SET VB6_OUTPUT=D:\FTCONTROLSMANAGER
SET FTSHUTDOWN_OUTPUT_FOLDER=D:\FTCONTROLSMANAGER\FTSYSTEMSHUTDOWN
SET VERSIONE=11.10.0.0
SET VERSIONE_WITH_TEXT=11.10.0.0-standalone
