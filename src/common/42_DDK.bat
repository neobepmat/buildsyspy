...
call "%BATCH_FOLDER%\setup\setup-DEVICEDRIVER-RELEASE.bat" %CONFIGURATION% %RILASCIO_UFFICIALE% %TDK_11_4% %DEVICE_DRIVER_VERSION% %PATH_MSBUILD% %ROOT_MOUNTPOINT_COMMON% %WIX_TARGETSPATH% %WIXCA_TARGETSPATH% >> %LOG_FILE% 2>>%LOG_FILE_ERR%
rem pause