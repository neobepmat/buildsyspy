...
SET VERSIONE_WITH_TEXT_INTERNAL=11.4.0.0-master
...
SET SLN_TDK_SETUP=%BATCH_ROOT_MOUNTPOINT_COMMON%\FT10-Setup\setup-project\setup-project.sln

SET OUTPUT_PATH=%BATCH_ROOT_MOUNTPOINT%\BuildSystem\src\msi-output\SETUPFT10

SET PACKAGE_FOLDER=%BATCH_ROOT_MOUNTPOINT_COMMON%\FT10-Setup\setup-project\setup-project\Packages\en-us

@ECHO --deleting old files in [%PACKAGE_FOLDER%]
DEL %PACKAGE_FOLDER%\*.* /Q

SET FT_SOURCEDIR=%BATCH_ROOT_MOUNTPOINT%\BuildSystem\artifacts
