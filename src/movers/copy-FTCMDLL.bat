...
IF %MAIN_TARGET_INTERNAL% == 12 (
	...
	COPY "%FTCM_SYS_FOLDER%\FTSystem.CommunicationFramework.MessageContracts.dll" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FTSystem.CommunicationFramework.MessageContracts.PDB" %TDK_DESTINATION_FOLDER%
...
REM ----------------------------------- Assembly per parte Plugin ----------------------------------- 
IF %MAIN_TARGET_INTERNAL% == 12 (
	COPY "%FTCM_SYS_FOLDER%\FT.CM.Pluging.AVBOS.Default.dll" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CM.Plugin.IE4000.Default.dll" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CM.Plugin.Presentation.Base.dll" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CFGM.HierarchySchema.Business.dll" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CFGM.HierarchySchema.Persistence.dll" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CFGM.HierarchySchema.Presentation.dll" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CFGM.HierarchySchema.VB6.dll" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CM.Common.PluginBridge.dll" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.AVBOS.dll" %TDK_DESTINATION_FOLDER%

	COPY "%FTCM_SYS_FOLDER%\FT.CM.Communication.DispatcherAVBOS.dll" %TDK_DESTINATION_FOLDER%

	COPY "%FTCM_SYS_FOLDER%\FT.CM.Pluging.AVBOS.Default.pdb" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CM.Plugin.IE4000.Default.pdb" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CM.Plugin.Presentation.Base.pdb" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CFGM.HierarchySchema.Business.pdb" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CFGM.HierarchySchema.Persistence.pdb" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CFGM.HierarchySchema.Presentation.pdb" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CFGM.HierarchySchema.VB6.pdb" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CM.Common.PluginBridge.pdb" %TDK_DESTINATION_FOLDER%
	COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.AVBOS.pdb" %TDK_DESTINATION_FOLDER%

	COPY "%FTCM_SYS_FOLDER%\FT.CM.Communication.DispatcherAVBOS.pdb" %TDK_DESTINATION_FOLDER%
