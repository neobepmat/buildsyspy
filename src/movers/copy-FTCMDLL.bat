...
rem COPY "%FTCM_EXE_SOURCE_FOLDER%\FTCONTROLSMANAGER.EXE" %FTCM_EXE_DESTINATION_FOLDER%
rem COPY "%FTCM_EXE_SOURCE_FOLDER%\FTCONTROLSMANAGERCONFIGURATOR.EXE" %FTCM_EXE_DESTINATION_FOLDER%

IF %MAIN_TARGET_INTERNAL% == 11-10 (
	COPY "%FTCM_TEMPLATE_INI_FOLDER%\11-10\FTControlsManager.ini" "%FTCM_EXE_DESTINATION_FOLDER%\FTCONTROLSMANAGER.INI.%FTCM_VERSIONE%"
)

IF %MAIN_TARGET_INTERNAL% == 11-4 (
	COPY "%FTCM_TEMPLATE_INI_FOLDER%\11-4\FTControlsManager.ini" "%FTCM_EXE_DESTINATION_FOLDER%\FTCONTROLSMANAGER.INI.%FTCM_VERSIONE%"
)
