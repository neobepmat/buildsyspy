...
SET FOLDER_AVBOS=AVBOS

SET TDKDEVICEDRIVER_DESTINATION_FOLDER=%BATCH_ROOT_MOUNTPOINT%\bitbucket-ft\BuildSystem\artifacts\TheDarkKnightDeviceDriver
...
SET DESTINATION_FOLDER_AVBOS=%TDKDEVICEDRIVER_DESTINATION_FOLDER%\%FOLDER_AVBOS%

MKDIR %DESTINATION_FOLDER_U1021%
MKDIR %DESTINATION_FOLDER_EX700MB%
MKDIR %DESTINATION_FOLDER_AVBOS%
...
COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.U1021.v4_22.*" %DESTINATION_FOLDER_U1021%
COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.U1021.v4_23.*" %DESTINATION_FOLDER_U1021%
COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.U1021.v4_24.*" %DESTINATION_FOLDER_U1021%
...
COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.EX700MB.v1_12.*" %DESTINATION_FOLDER_EX700MB%
COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.EX700MB.v1_13.*" %DESTINATION_FOLDER_EX700MB%
COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.EX700MB.v1_14.*" %DESTINATION_FOLDER_EX700MB%
COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.EX700MB.v1_15.*" %DESTINATION_FOLDER_EX700MB%
COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.EX700MB.v1_16.*" %DESTINATION_FOLDER_EX700MB%
COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.EX700MB.v1_17.*" %DESTINATION_FOLDER_EX700MB%

REM --------------------------------------- AVBOS ----------------------------------- 
REM RIPULISCE LA DIRECTORY DI DESTINAZIONE THE DARK KNIGHT DEVICE DRIVER per ABVBOS
DEL /F /Q "%DESTINATION_FOLDER_AVBOS%\*.*"
COPY "%FTCM_SYS_FOLDER%\FT.CM.Plc.AVBOS.v1_00.*" %DESTINATION_FOLDER_AVBOS%