...
SET LOG_FILE=%ROOT_FOLDER%\src\log\SETUP_12_standalone.LOG
SET LOG_FILE_ERR=%ROOT_FOLDER%\src\log\SETUP_ERR_12_standalone.LOG
SET VB6_OUTPUT=D:\FTCONTROLSMANAGER
SET FTSHUTDOWN_OUTPUT_FOLDER=D:\FTCONTROLSMANAGER\FTSYSTEMSHUTDOWN
SET VERSIONE=13.0.0.0
SET VERSIONE_WITH_TEXT=13.0.0.0-standalone
