...
@ECHO Starting TAG procedure for branch [%BRANCH_11-4_TO_TAG_INTERNAL%] on folder [%GIT-ROOT%] > "%EXT_LOG_FILE%" 2>"%EXT_LOG_FILE_ERR%"
...
SET BRANCH_TO_TAG_INTERNAL=%BRANCH_11-4_TO_TAG_INTERNAL%
SET DEMO=%DEMO%
