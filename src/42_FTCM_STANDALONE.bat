...
call "%BATCH_FOLDER%\builders\build-OVERLORD ver-NON-ufficiale.bat" %VERSIONE_WITH_TEXT% %VERSIONE% %ROOT_MOUNTPOINT% %VB6_OUTPUT% %STANDALONE% >> %LOG_FILE% 2>> %LOG_FILE_ERR%
